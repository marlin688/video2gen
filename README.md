...
│       ├── knowledge_ideation.md  # 竞品分析 + 创意构思
│       ├── knowledge_hook.md      # 钩子生成
│       ├── knowledge_title.md     # 标题生成 + 历史对标
│       ├── knowledge_outline.md   # 大纲生成
│       ├── knowledge_waterfall.md # 内容瀑布分发
│       └── knowledge_shorts.md    # 短视频脚本
